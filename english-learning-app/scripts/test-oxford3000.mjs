...
const legacy=read('fun-lessons-v67.js'),v68=read('fun-lessons-v68.js'),v69=read('fun-lessons-v69.js'),v70=read('fun-lessons-v70.js');
...
assert(v69.includes("const V='v69'"),'v69 rollback cartoon engine missing');
assert(v70.includes("const V='v70'"),'v70 Thai-first teacher engine missing');
assert(v70.includes('aria-label="ครูเมย์ การ์ตูนครูภาษาไทย"'),'v70 redesigned teacher missing');
assert(v70.includes('aria-label="มิน นักเรียนการ์ตูน"')&&v70.includes('aria-label="นนท์ นักเรียนการ์ตูน"'),'v70 student characters missing');
assert(v70.includes("const sayTh=t=>speak(t,'th-TH')"),'v70 Thai teacher narration missing');
assert(v70.includes("englishRole:'learning-content-only'"),'v70 English must be learning content only');
assert(v70.includes('databaseMediaStorage:false'),'v70 media must stay out of database');
assert(!v70.includes('MutationObserver'),'v70 must remain event-driven');

const index=read('index.html');
const required=['account-gate.js?v=61','daily-course-v53.js?v=53','curriculum-variety-v60.js?v=60','fun-lessons-v70.js?v=70','fun-lessons-v70.css?v=70','fun-lessons-v69.js?v=69','fun-lessons-v68.js?v=68','fun-lessons-v68.css?v=68','institute-course-v62.js?v=62','answer-integrity-v63.js?v=63','lesson-variety-v64.js?v=64','mastery-variety-v64b.js?v=64','interaction-quality-v65.js?v=65'];
...
assert(index.indexOf('fun-lessons-v70.js?v=70')<index.indexOf('fun-lessons-v69.js?v=69'),'v70 click capture must register before v69');
assert(index.indexOf('fun-lessons-v69.js?v=69')<index.indexOf('fun-lessons-v68.js?v=68'),'v69 rollback capture must stay before provider');
...
const sw=read('sw.js');
assert(sw.includes("const CACHE='my-english-v70'"),'Service worker cache must be v70');
for(const asset of ['./fun-lessons-v70.js?v=70','./fun-lessons-v70.css?v=70','./fun-lessons-v69.js?v=69','./fun-lessons-v68.js?v=68','./fun-lessons-v68.css?v=68','./interaction-quality-v65.js?v=65','./lesson-variety-v64.js?v=64','./account-gate.js?v=61'])assert(sw.includes(asset),`Service worker missing ${asset}`);
assert(!sw.includes('./fun-lessons-v67.js?v=67'),'Current PWA cache must not serve v67 lesson engine');

console.log(JSON.stringify({ok:true,rows:3000,courseLessons:210,separateLearnerLogin:true,registrationClosed:true,rollbackVersion:'v67',providerVersion:'v68',cartoonRollbackVersion:'v69',funLessonVersion:'v70',thaiFirst:true,cartoonRedesign:true,databaseMediaStorage:false,noContinuousObservers:true},null,2));
