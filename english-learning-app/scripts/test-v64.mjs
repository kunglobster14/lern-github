...
assert(sw.includes('./lesson-variety-v64.css?v=64')&&sw.includes('./lesson-variety-v64.js?v=64')&&sw.includes('./mastery-variety-v64b.js?v=64'),'Service worker must cache v64 assets');
console.log(JSON.stringify({ok:true,version:'v64',production:{sentences:2,styles:production.productionStylesUsed,distinctSignatures:production.distinctProductionSignatures,speakingEveryLesson:production.speakingEveryLesson},mastery},null,2));
