(()=>{
  ...
  function renderCard(){
    ...
    const html=`<section id="core3000Plan" class="core3000-card"><div class="core3000-head"><div><div class="hero-kicker">OXFORD 3000 PLAN</div><h2>Oxford 3000 · CEFR A1–B2</h2><p>สุ่มคำที่ยังไม่ผ่าน · เรียนใหม่ ${p.daily} คำ/วัน · ${p.daysPerWeek} วัน/สัปดาห์ · มีคลังคำศัพท์ Quiz และเรื่องอ่าน 10 เรื่อง</p></div><div class="core3000-ring"><b>${pct}%</b><span>${mastered}/${TARGET}</span></div></div><div class="core3000-progress"><i style="width:${pct}%"></i></div><div class="core3000-stats"><div><b>${p.daily}</b><span>คำใหม่/วัน</span></div><div><b>${e.weekly}</b><span>คำใหม่/สัปดาห์</span></div><div><b>~${e.weeks}</b><span>สัปดาห์</span></div><div><b>~${e.months}</b><span>เดือน</span></div></div><div class="core3000-routine"><b>🎧 วิธีผ่านแต่ละคำ</b><span>เข้าใจความหมาย → ฟัง/พูดตามคำ 3 รอบ → อ่านและพูดตามประโยค 2 รอบ → ผ่านคำนี้</span></div><div class="core3000-actions four"><button type="button" class="secondary-btn" id="core3000LibraryBtn">คลัง 3,000 คำ</button><button type="button" class="secondary-btn" id="core3000Quiz">สุ่ม Quiz 20 คำ</button><button type="button" class="secondary-btn" id="core3000Stories">เรื่องอ่าน 10 เรื่อง</button><button type="button" class="primary-btn" id="core3000Start">เริ่ม ${p.daily} คำวันนี้</button></div><button type="button" class="secondary-btn" id="core3000Settings" style="margin-top:10px;width:100%">ปรับจำนวนคำ/วัน</button><small class="core3000-note">ทบทวนแบบเว้นระยะ: วัน ${reviewSchedule.join(' · ')} หลังเรียนคำใหม่ · ชุดคำศัพท์หลัก Oxford 3000™ Thai Study Edition</small></section>`;
