...
for(const f of ['classic-games-v85.js','game-home-v85.js','game-audio-v85b.js','story-depth-v85-data.js','story-integrity-v85.js','story-depth-v84.js']){const r=spawnSync(process.execPath,['--check',new URL(`../${f}`,import.meta.url).pathname],{encoding:'utf8'});assert.equal(r.status,0,`${f} syntax error: ${r.stderr||r.stdout}`)}
const games=read('classic-games-v85.js'),home=read('game-home-v85.js'),audio=read('game-audio-v85b.js'),integrity=read('story-integrity-v85.js'),loader=read('story-depth-v84.js'),sw=read('sw.js');
