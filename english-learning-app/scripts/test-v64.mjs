...
assert(index.includes('fun-lessons-v68.js?v=68'),'Current index must activate v68 lesson engine');
assert(sw.includes("const CACHE='my-english-v68'"),'Current service worker cache must be v68');
...
assert(sw.includes('./fun-lessons-v68.js?v=68'),'Service worker must cache v68 lesson engine');
console.log(JSON.stringify({ok:true,version:'v64',production:{sentences:2,styles:production.productionStylesUsed,distinctSignatures:production.distinctProductionSignatures,speakingEveryLesson:production.speakingEveryLesson},mastery,compatibleWith:'v68'},null,2));
