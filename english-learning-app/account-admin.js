(()=>{
  ...
  const msg=c=>({username_taken:'Username นี้ถูกใช้แล้ว',invalid_username:'Username ต้องยาว 3–30 ตัว',invalid_password:'Password ต้องมีอย่างน้อย 8 ตัวอักษร',user_limit_reached:'ครบ 10 บัญชีแล้ว',admin_required:'เฉพาะผู้ดูแลระบบ'}[c]||'สร้างบัญชีไม่สำเร็จ');
