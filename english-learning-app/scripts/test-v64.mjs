...
assert(index.includes('fun-lessons-v67.js?v=67'),'Current index must activate v67 lesson engine');
assert(sw.includes("const CACHE='my-english-v67'"),'Current service worker cache must be v67');
...
assert(sw.includes('./fun-lessons-v67.js?v=67'),'Service worker must cache v67 lesson engine');
console.log(JSON.stringify({ok:true,version:'v64',production:{sentences:2,styles:production.productionStylesUsed,distinctSignatures:production.distinctProductionSignatures,speakingEveryLesson:production.speakingEveryLesson},mastery,compatibleWith:'v67'},null,2));
