...
assert(sw.includes("const CACHE='my-english-v65'"),'Current service worker cache must be v65');
...
console.log(JSON.stringify({ok:true,version:'v64',production:{sentences:2,styles:production.productionStylesUsed,distinctSignatures:production.distinctProductionSignatures,speakingEveryLesson:production.speakingEveryLesson},mastery,compatibleWith:'v65'},null,2));
